#!/usr/bin/env python3
"""
Chrome Session Manager - Termux WebSocket Fix
Uses direct HTTP requests and proper WebSocket handling for Termux
"""
...
class ChromeDevTools:
    """Chrome DevTools Protocol with Termux WebSocket fixes"""
    ...
    def _get_websocket_connection(self, tab_id: str):
        """Get WebSocket connection with proper handling for Termux"""
        ...
        # Clean up the URL
        ws_url = ws_url.strip()
        ws_url = re.sub(r',.*$', '', ws_url)  # Remove trailing commas and anything after
...
class ChromeSessionManager:
    ...
    def start_session(self, session_id: int):
        ...
        # Chrome flags with proper WebSocket support for Termux
        cmd = [
            self.chrome_path,
...
"""
    ...
    def interactive_menu(self):
        ...
        while True:
            ...
            header = """
╔══════════════════════════════════════════════════════════════╗
║           🌐 Chrome Session Manager - Termux Fix          ║
