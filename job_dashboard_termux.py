# job_dashboard_termux.py - Interactive dashboard for Termux
import json
import sys
import os
...
class TermuxJobDashboard:
    ...
    def show_commands(self):
        ...
        print("  8. clear    - Clear screen")
        print("  9. quit     - Exit dashboard")
        print("-" * 70)
    ...
    def show_trends(self):
        ...
        print("\n📍 Top Locations:")
        for location, count in analysis['locations'].most_common(5):
    ...
    def run(self):
        ...
        while self.running:
            ...
            if cmd == 'quit' or cmd == 'exit' or cmd == '9':
                self.running = False
                print("\nGoodbye! 👋")
                break
