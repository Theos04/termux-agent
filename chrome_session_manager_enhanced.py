...
class ChromeDevTools:
    ...
    def _ensure_connection(self) -> bool:
        try:
            response = self.session.get(f"{self.base_url}/json", timeout=2)
...
class ChromeSessionManager:
    ...
    def create_session(self):
        ...
        while True:
            name = Prompt.ask("📝 Session name (e.g., semanticscholar)")
            if not name:
        ...
        url = Prompt.ask("🌐 Website URL", default="https://www.semanticscholar.org")
        ...
        try:
            ...
            for i in range(15):
                ...
                if devtools._ensure_connection():
                    connected = True
                    break
                console.print(f"[dim]Waiting... ({i+1}/15)[/dim]")
