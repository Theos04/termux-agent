...
Version: Final - With all improvements
...
- Action pruning with landmarks
- Stable selectors
- Structural state IDs
- Episode tracking for best paths
"""
...
class StateExtractor:
    ...
    def _compute_state_id(self, state: Dict) -> str:
        ...
        # Count landmarks for fingerprint
...
class QLearningAgent:
    ...
    def check_goal_achieved(self, state: Dict) -> bool:
        # Strict goal detection - only detect confirmed goals
        page = state.get('page', {})
        text = page.get('text', '').lower()
        
        # Only detect confirmed success indicators
        success_indicators = [
